...
function SavedCardsContainer() {
    ...
    const renderFavorites = favorites.length > 0 ? favorites.map(card => <SavedCardDetails key={card.id} handleRemove={removeFromFavorites} card={card} />) : "You don't have any saved cards, please add some to you favorites to see them here!"
